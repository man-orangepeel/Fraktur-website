...
const PAUSE_MS = 200; // hold on the fissure so it's clearly visible before it worsens
const EXPLODE_MS = 1000; // phase 2: fissure widens, block separates and fades out
