    ...
    <footer className="border-t border-fraktur-border bg-fraktur-panel py-10 text-sm text-fraktur-muted">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <p className="mb-4 max-w-2xl leading-relaxed">
          Donations are voluntary tips for open Bitcoin security research — not investments, equity, or any promise of
          financial return.{" "}
        ...
        <p className="mt-6 text-xs text-fraktur-muted/70">
